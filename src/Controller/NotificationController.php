...
class NotificationController extends AbstractController
{
    ...
    /**
     * @Route("/reverse-acknowledge-all", name="notification_reverse_acknowledge_all")
     */
    public function reverseAcknowledgeAll()
    {
        $this->notificationRepository->markAllAsUnReadByUser($this->getUser());
        $this->getDoctrine()->getManager()->flush();
